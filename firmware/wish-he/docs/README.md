...
| 12. 8kHz 로 올리기 | 완료 콜백에서 재무장, **스캔을 슈퍼루프에서 떼어내기** — 상용 25us 대비 우리 62us ([05편 비교](05-adc-scan.md#상용과-비교--같은-구조-다른-예산-배분)) | 예정 |
| 13. 래피드 트리거 | ADC 값 → 거리, 액추에이션 조정. **3개 누적으로 잡음 √3 감소**, 드리프트 분산. 튜닝 화면은 11편의 VIA 포크에 | 예정 |
